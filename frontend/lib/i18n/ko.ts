...
export const ko = {
  ...
  page: {
    ...
    checkpointsEmptyTitle: "체크포인트 정보가 아직 없습니다.",
    checkpointsEmptyBody: "실시간 정보가 들어오면 이 영역에 동선별 대기시간과 운영 메모를 바로 보여줍니다.",
    ...
    mainStates: {
      loading: {
        title: "대기시간 정보를 불러오는 중입니다.",
        body: "현재 공항 운영 데이터를 받아오는 중입니다. 잠시 후 최신 상태와 체크포인트 정보를 표시합니다."
      },
      empty: {
        title: "표시할 대기시간 정보가 아직 없습니다.",
        body: "운영 데이터가 준비되면 예상 대기시간과 상태, 체크포인트 안내를 같은 위치에 보여줍니다."
      },
      error: {
        title: "대기시간 정보를 가져오지 못했습니다.",
        body: "일시적인 통신 문제일 수 있습니다. 잠시 후 다시 확인하면 최신 안내를 불러옵니다."
      },
      stale: {
        title: "현재 화면은 최근 데이터를 기준으로 표시 중입니다.",
        body: "업데이트가 지연되고 있어 최신 값과 차이가 있을 수 있습니다. 공항 안내 방송도 함께 확인해 주세요."
      },
      maintenance: {
        title: "잠시 점검 중입니다.",
        body: "운영 데이터 갱신이 일시 중단되었습니다. 점검이 끝나면 대기시간과 체크포인트 안내가 자동으로 다시 표시됩니다."
      }
    }
  },
  airportSwitcher: {
